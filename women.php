...
<style>
    #poster {
        ...
        width: 100%;
        height: 750px;
        background: url('https://cdn.shopify.com/s/files/1/0250/5696/8738/files/MOBILE_TOP_BANNER_sneakers.jpg?v=1681825993%22/') no-repeat;
        background-size: 100%;
    }
</style>
...
<body>
    <div id="main">
        <div id="header">
            ...
            <div id="header-end" class="text-align">
                <ul id="main-menu">
                    ...
                    <li><a style="border-bottom: 5px solid #c70101" href="">Nữ</a></li>
        ...
        <div id="content">
            ...
            <div class="container">
                <?php
                $sql = "SELECT * FROM products WHERE type = 'nu'";
