...
<style>
    #poster {
        ...
        width: 100%;
        height: 635px;
        background: url('https://images.squarespace-cdn.com/content/v1/5989e9cfcf81e028a031dd23/1504071395098-JABWMJOMV1GM6WNC88EN/kidssneakersbanner.png?format=1500w') no-repeat;
        background-size: 100%;
    }
        ...
        <div id="header">
            ...
            <div id="header-end" class="text-align">
                <ul id="main-menu">
                    ...
                    <li><a style="border-bottom: 5px solid #c70101" href="">Trẻ em</a></li>
                </ul>
            </div>
        </div>
        <div id="content">
            ...
            <div class="container">
                <?php
                $sql = "SELECT * FROM products WHERE type = 'treem'";
